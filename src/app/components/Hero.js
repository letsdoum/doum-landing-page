...
<div className='circleConMob flex md:hidden bg-[#004aad] rounded-full h-[120vw] w-[120vw] ml-[-8.75vw] justify-center items-center text-center'>
        ...
        <Toaster />
          <div className='circleCon md:h-full md:w-[25%] ml-[-35vw] lg:ml-[-40vw] overflow-x-visible hidden md:inline-block'> <div className='formCircle h-[175vh] w-[175vh]  rounded-full bg-[#004aad] flex flex-col items-end justify-center gap-[3vh]'>
             <div className='headingCon  mr-[22vh] lg:mr-[25vh] h-[25%] w-[40%] mt-[-8vh]'>
              <h1 className='text-[#e1eefd] text-4xl font-glacial font-bold '>
              Be among the First 100 to enjoy a FREE service along with Exciting Surprise Gifts! Don't miss out!
              </h1>
              </div>  
             <div className='contact-info h-[8%] w-[30%] mr-[39vh] lg:mr-[42vh] mb-[0vh] mt-[-12vh] '>
             
             <a href='mailto:helpdesk@mydoum.com' className='font-glacial text-[#e1eefd] text-2xl font-light'> helpdesk@mydoum.com</a>
             </div>
             <div className='whatsapp h-[5%] w-[35%] mr-[17vh] lg:mr-[20vh] mt-[-10vh]' >
              <a href='https://wa.me/918967908081' className='font-glacial text-[#e1eefd] text-2xl font-thin whitespace-nowrap flex items-center justify-start gap-4 ml-[-13vh] lg:ml-[-16vh]   '>Need help? Message us! <div><BsWhatsapp color='#e1eefd' /></div>  </a> </div>
              <div className='address font-glacial text-[#e1eefd] text-2xl font-light h-[10%] w-[40%] mr-[22vh] lg:mr-[25vh] mt-[-5vh] '>Salt Lake City, Kolkata,Kolkata 700091,West Bengal, India</div>
