...
function Navbar() {
    ...
    return (
        ...
        <div ref={barRef} className='hidden md:flex h-[15vh] w-[50vw] rounded-full bg-[#bbd7f47a] justify-center items-center drop-shadow-2xl fixed top-12 left-1/20 z-20 object-contain gap-6 backdrop-blur-xl min-w-[320px] overflow-hidden'>
            ...
            <Link href='#whyUs' className='text-sm h-1/4 w-1/8 text-[#18375d] font-bold my-6 font-glacial navitem' ref={el => linksRef.current[2] = el}>Why us</Link>
            <Link href='#faq' className='text-sm h-1/4 w-1/8 text-[#18375d] font-bold my-6 font-glacial navitem' ref={el => linksRef.current[3] = el}>FAQs</Link>
            <Link href='#waitlist' className='text-sm h-1/4 w-1/8 text-[#18375d] font-bold my-6 font-glacial navitem' ref={el => linksRef.current[4] = el}>Join Waitlist</Link>
        </div>
        {/* <div className='flex md:hidden h-[10vh] w-full bg-[#bbd7f47a] justify-between items-center fixed top-0'>
            <div className='w-[40%] h-full filxed left-2' style={{ backgroundImage: 'url(/DOUM-logo-removebg-preview.webp)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', mixBlendMode: 'multiply' }} ></div>
        ...
        <div ref={panelRef} className='flex flex-col h-[40vh] w-[60vw] justify-evenly bg-[#bbd7f47a] rounded-lg backdrop-blur-xl fixed right-[-100vw] top-[10vh] z-[200] opacity-0'>
